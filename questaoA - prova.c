...
int main(){
	int particoes[] = {10,4,20,19,27,9,12,13,15};
	int alocacao[N];
	int desperdicado[N];
	int casos[] = {12};
	...
	firstFit(particoes,alocacao,desperdicado,casos,1);
	imprimeMemoria(particoes,alocacao,desperdicado);
	iniciaAlocacao(alocacao);
	inicializaDesperdicado(particoes,desperdicado);
	
	printf ("\n\nALOCACAO DE MEMORIA USANDO ESTRATEGIA BEST-FIT\n");
	bestFit(particoes,alocacao,desperdicado,casos,1);
	imprimeMemoria(particoes,alocacao,desperdicado);
	iniciaAlocacao(alocacao);
	inicializaDesperdicado(particoes,desperdicado);
	
	printf ("\n\nALOCACAO DE MEMORIA USANDO ESTRATEGIA WORST-FIT\n");
	worstFit(particoes,alocacao,desperdicado,casos,1);
	imprimeMemoria(particoes,alocacao,desperdicado);
	iniciaAlocacao(alocacao);
	inicializaDesperdicado(particoes,desperdicado);
