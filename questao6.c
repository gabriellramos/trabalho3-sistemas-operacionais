...
int main(){
	...
	firstFit(particoes,alocacao,desperdicado,casos,7);
	imprimeMemoria(particoes,alocacao,desperdicado);
	iniciaAlocacao(alocacao);
	inicializadesperdicado(particoes,desperdicado);
	
	printf ("\n\nALOCACAO DE MEMORIA USANDO ESTRATEGIA BEST-FIT\n");
	bestFit(particoes,alocacao,desperdicado,casos,7);
	imprimeMemoria(particoes,alocacao,desperdicado);
	iniciaAlocacao(alocacao);
	inicializadesperdicado(particoes,desperdicado);
	
	printf ("\n\nALOCACAO DE MEMORIA USANDO ESTRATEGIA WORST-FIT\n");
	worstFit(particoes,alocacao,desperdicado,casos,7);
	imprimeMemoria(particoes,alocacao,desperdicado);
	iniciaAlocacao(alocacao);
	inicializadesperdicado(particoes,desperdicado);
	
	printf ("\n\nALOCACAO DE MEMORIA USANDO ESTRATEGIA NEXT-FIT\n");
	nextFit(particoes,alocacao,desperdicado,casos,7);
	imprimeMemoria(particoes,alocacao,desperdicado);
	iniciaAlocacao(alocacao);
	inicializadesperdicado(particoes,desperdicado);
